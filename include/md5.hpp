...
namespace md5
{
    ...
    static constexpr uint32_t DIGEST_INTS = 4; // number of 32bit integers per MD5 digest
    static constexpr uint32_t BLOCK_INTS = 16; // number of 32bit integers per MD5 block
